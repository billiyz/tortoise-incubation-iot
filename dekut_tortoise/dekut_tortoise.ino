#define KAA_TOKEN "tortoise"     // Endpoint token
#define KAA_APP_VERSION "XXXXX-dekuttortoise1"  // Application version that endpoint works in

#define WIFI_SSID "dekut"              // DeKUT WiFi network SSID
#define WIFI_PASS "XXXXXXXX"       // DeKUT WiFi network password
...
#define OUTPUT_3_NAME "latitude"
#define OUTPUT_4_NAME "longitude"
...
//Constants
#define DHTPIN 7     // dht22 connected to D7
...
void composeAndSendMetadata() {
  ...
  doc_data["location"] = "Dekut_conservation";
  doc_data["longitude"] = 36.958864;
  doc_data["latitude"] = -0.389069;
...
void sendOutputsState() {
  ...
  doc_data[0][OUTPUT_1_NAME] = temp;
  doc_data[1][OUTPUT_2_NAME] = hum;
  doc_data[2][OUTPUT_3_NAME] = lat;
  doc_data[3][OUTPUT_4_NAME] = lon;
